...
namespace ShopOnlineApi.Data
{
    ...
    public class BloggingContextFactory : IDesignTimeDbContextFactory<ShopOnlineDbContext>
    {
        public ShopOnlineDbContext CreateDbContext(string[] args)
        {
            ...
            var connectionString = config.GetConnectionString("ShopOnlineConnection");
